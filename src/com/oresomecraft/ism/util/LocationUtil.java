...
/*
 TAKEN FROM ESSENTIALS LocationUtil, all credit goes to Essentials for this code.
 */

public class LocationUtil {
    // The player can stand inse these materials
    ...
    public static boolean checkBlocksAbove(Location l) {
